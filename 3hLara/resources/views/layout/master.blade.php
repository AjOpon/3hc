            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{action('pages@home')}}/services">Socia Media</a></li>
                        <li class="dropdown">
                            <a href="{{action('pages@home')}}/tracks" class="dropdown-toggle" data-toggle="dropdown">Music <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="{{action('pages@home')}}/mixtapes">Mixtapes</a></li>
                                <li><a href="{{action('pages@home')}}/singles">Singles</a></li>
                                <li><a href="{{action('pages@home')}}/podcasts">Podcast</a></li>
                            </ul>
                        </li>
                        @if (Auth::guest())
                        <li class="dropdown">
